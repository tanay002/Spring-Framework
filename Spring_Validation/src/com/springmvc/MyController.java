...
{ 
	...
	public String doRegister(@Valid @ModelAttribute("user") UserDto user,BindingResult result)
	{  
		if(result.hasErrors())
		{
			return "registration";
		...
		else
		{
			...
			/*
			 * ModelAndView mv=new
			 * ModelAndView("loginpage","msg","you have successfully registered");
			 */
			return "loginpage";
		}
	}
	...
	public ModelAndView changePassword(HttpServletRequest req,HttpSession ses)
	{
		...
		if(newpass.equals(confirmpass))
		{
			...
			{
				List ls=temp.findByNamedQuery("getData");
